/*
Soln:
Iterate from m to 1 and create a tree using dsu with weight = gcd
Since height will be max logn. Just brute force over the path to find min weight edge.
*/
