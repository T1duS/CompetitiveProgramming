/*
Soln:
dp[i][j] denotes ans for range i..j
either take i or don't take i
if u dont take i, u'll get dp[i+1][j]
if u do take i, u'll get 1+dp[i+1][x1-1]+dp[x1+1][x2-1]+dp[x2+1][x3-1]...dp[xk+1][j]
where x denotes the list of elements u can't take
*/
